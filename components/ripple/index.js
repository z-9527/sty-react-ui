...
class Ripple extends Component {
  ...
  onTouchStart = (event) => {
    ...
    this.shadowDiv && this.shadowDiv.parentNode && this.shadowDiv.parentNode.removeChild(this.shadowDiv);
    ...
    shadowDiv.style.transition = shadowDiv.style.webkitTransition = 'transform 0.25s ease-in-out 0s';
  ...
  onTouchEnd = () => {
    ...
    this.shadowDiv.style.transition = `transform ${duration}s ease-in-out 0s, opacity ${duration - 0.3}s linear 0s`;
  ...
  state = {}
  render() {
    const { prefixCls, className, center, children, color, ...other } = this.props;
    return (
      <div
