    ...
    return (
      <div className='action-sheet-demo demo-box'>
        ...
        <Cell
          title='基础用法'
          arrow='right'
          onClick={() => this.onShow({ ...base })}
        />
        <Cell
          title='展示取消按钮'
          arrow='right'
          onClick={() => this.onShow({ ...base, cancelText: '取消' })}
        />
        <Cell
          title='展示描述信息'
          arrow='right'
          onClick={() =>
            this.onShow({ ...base, description: '这是一段描述信息' })
          }
        />
        ...
        <Cell
          ...
          onClick={() =>
            this.onShow({
              title: '标题',
              children: <div className='content'>内容</div>
            })
          }
        />
