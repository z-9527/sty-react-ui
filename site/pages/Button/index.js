  ...
  render() {
    return (
      <div className='button-demo demo-box'>
        ...
        <Button round inline type='ghost'>
          round
        </Button>
        ...
        <Button disabled inline type='primary'>
          primary
        </Button>

        <div className='section-title'>加载和图标</div>
        <Button loading inline type='primary'>
          primary
        </Button>
        <Button loading inline type='warning'>
          warning
        </Button>
        <Button inline icon='like-o' type='ghost'>
          ghost
        </Button>
      </div>
    );
