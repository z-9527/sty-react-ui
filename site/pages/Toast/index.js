  ...
  render() {
    ...
    return (
      <div className='toast-demo demo-box'>
        ...
        <Button inline onClick={() => this.showToast(configs[0])}>
          文字提示
        </Button>
        <Button inline onClick={() => this.showToast(configs[1])}>
          长文字提示
        </Button>

        <div className='section-title'>加载提示</div>
        <Button inline onClick={() => this.showToast(configs[2])}>
          加载提示
        </Button>
        ...
        <Button
          inline
          type='primary'
          onClick={() => this.showToast(configs[3])}
        >
          成功提示
        </Button>
        <Button
          inline
          type='warning'
          onClick={() => this.showToast(configs[4])}
        >
          失败提示
        </Button>

        <div className='section-title'>自定义图标</div>
        <Button inline onClick={() => this.showToast(configs[5])}>
          自定义图标
        </Button>
        <Button inline onClick={() => this.showToast(configs[6])}>
          自定义图标
        </Button>
      </div>
    );
